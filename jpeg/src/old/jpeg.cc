...
void
jpeg_read (unsigned char *read_buf, int *OutData_image_width, int *OutData_image_height, unsigned char OutData_comp_buf[RGB_NUM][BMP_OUT_SIZE])
{
...
decode_start (int *out_data_image_width, int *out_data_image_height,
	      int *out_data_comp_vpos, int *out_data_comp_hpos, unsigned char OutData_comp_buf[RGB_NUM][BMP_OUT_SIZE])
{
  int i;
  int CurrentMCU = 0;
